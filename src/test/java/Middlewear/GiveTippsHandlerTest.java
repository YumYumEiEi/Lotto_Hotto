...
class GiveTippsHandlerTest {
    ...
    @Test
    public void shouldShowAnErrorMessageIfNoSuperzahlWasPicked(){
        //Setup
        User currendUser = new User("Peter", "1234wasd");
        String[] tippedNumbers = new String[]{"3", "7", "18", "21", "22", "29", "46"};

        TippActionObject testTipp = new TippActionObject( tippedNumbers, "", currendUser);
        ...
        //Assert
        verify(mockBackend, times(0)).saveTipp(any(Tipp.class));
        verify(mockFrontend, times(1)).showNoSuperzahlPickedErrorMessage();
    }
